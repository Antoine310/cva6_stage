# CVA6 Stage Organisation des branch importante : 

- Synthese_Simple : Version de Base au bon commit pour les comparaison synthse. 

- Work : Version 1 actuel (stall commit) 

- Work_version2 : Version 2 actuel (load csr read cycle)
  
- Version3 (bonus) : Version 3, (predic+version1)

- [!] VersionFusion : Dernière Branch a jours mode multi load + enclave
