...
#define REP34(x) REP16(x) REP16(x) REP2(x) 
#define REP36(x) REP16(x) REP16(x) REP4(x)
#define REP38(x) REP16(x) REP16(x) REP6(x)
#define REP40(x) REP16(x) REP16(x) REP8(x)

#define REP48(x) REP16(x) REP16(x) REP16(x)
